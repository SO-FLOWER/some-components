...
import Clock from './itemStudy/time.js'
import PreventRender from './itemStudy/preventrender.js'
import Events from './itemStudy/event.js'
import Condition from './itemStudy/conditionrender.js'
import Keyid from './itemStudy/key.js'
import Setstates from './itemStudy/setstats'
import './index.css'
...
class EchartsRender extends React.Component{
  ...
  onChartLegendselectchangded(param,echarts){
      console.log(param);
  }
  ...
  render(){
    let onEvents = {
       ...
       'legendselectchanged':this.onChartLegendselectchangded.bind(this)
    }
    return(
      <div className="echartsRender">
